...
DEFAULT_WEBRTCBIN_VP8_OUT_PIPELINE = '''
    ...
    rtpvp8pay name=payloader auto-header-extension=true picture-id-mode=15-bit mtu=1380 ! queue !
    capsfilter name=payloader_capsfilter ! webrtc.
'''
...
DEFAULT_WEBRTCBIN_VP9_OUT_PIPELINE = '''
    ...
    rtpvp9pay name=payloader auto-header-extension=true picture-id-mode=15-bit mtu=1380 ! queue !
    capsfilter name=payloader_capsfilter ! webrtc.
'''
...
DEFAULT_WEBRTCBIN_AV1_OUT_PIPELINE = '''
    ...
    rtpav1pay name=payloader auto-header-extension=true mtu=1380 ! queue !
    capsfilter name=payloader_capsfilter ! webrtc.
'''
