...
DEFAULT_BIN_PIPELINE = '''
    ...
    rtph264pay name=payloader auto-header-extension=true aggregate-mode=zero-latency config-interval=1 mtu=1370 !
...
DEFAULT_H265_IN_WEBRTCBIN_H264_OUT_CUDA_PIPELINE = '''
    ...
    rtph264pay name=payloader auto-header-extension=true config-interval=1 mtu=1370 ! 
    capsfilter name=payloader_capsfilter caps="application/x-rtp, media=(string)video, clock-rate=(int)90000, encoding-name=(string)H264, payload=(int)126" ! webrtc.
'''
...
DEFAULT_WEBRTCBIN_H265_OUT_PIPELINE = '''
    ...
    rtph265pay name=payloader auto-header-extension=true config-interval=1 mtu=1370 ! 
...
DEFAULT_WEBRTCBIN_VP8_OUT_PIPELINE = '''
    ...
    rtpvp8pay name=payloader auto-header-extension=true picture-id-mode=15-bit mtu=1370 ! 
    capsfilter name=payloader_capsfilter ! webrtc.
'''
...
DEFAULT_WEBRTCBIN_VP9_OUT_PIPELINE = '''
    ...
    rtpvp9pay name=payloader auto-header-extension=true picture-id-mode=15-bit mtu=1370 ! 
    capsfilter name=payloader_capsfilter ! webrtc.
'''
...
DEFAULT_WEBRTCBIN_AV1_OUT_PIPELINE = '''
    ...
    rtpav1pay name=payloader auto-header-extension=true mtu=1370 ! 
    capsfilter name=payloader_capsfilter ! webrtc.
'''
